...
export default function TermsOfService() {
   return (
      <Layout title="Terms of Service - Whisper Verse">
         <section className="flex flex-col justify-center sm:p-20 p-6 py-16 my-auto">
            <div className="mx-auto flex flex-col gap-6 p-6 shadow text-black bg-white rounded-[20px]">
               ...
               <p>
                  Welcome to Whisper Verse! By using Whisper Verse and its
                  services, you agree to comply with and be bound by the
                  following terms and conditions. Please review them carefully.
                  If you do not agree to these terms, please do not use Whisper
                  Verse.
               </p>

               <h2 className="text-xl font-bold mt-6">User Conduct</h2>
               <p>
                  When using Whisper Verse, you agree to:
                  <ul className="">
                     <li>Use Whisper Verse only for lawful purposes</li>
               ...
               <p>
                  Whisper Verse and its content, features, and functionality are
                  owned by Whisper Verse and are protected by international
               ...
               <p>
                  Whisper Verse is provided "as is" and "as available" without
                  any representations or warranties, expressed or implied.
                  Whisper Verse makes no representations or warranties in
               ...
               <p className="mt-8">
                  Thank you for using Whisper Verse responsibly. Your compliance
